...
# Exemplo de execução:
# clear ; python -m http.server -d .\190_site\ 3333
# Limpar comando ; executar python do modulo http.serve o diretorio 190_site na porta 3333
# Objetivo: Visualizar resquisições feito ao server