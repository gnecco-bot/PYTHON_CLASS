...
# Abra a pasta do seu projeto no terminal do powershell
# e digite:
# python -m venv venv <== este vai ser o nome da seu ambiente virtual
#
...
# pip freeze
#
# Criando e usando um requirements.txt (ele salva todas as versões dos modulos)
