...
# data_fim = datetime.strptime('20/12/2025', '%d/%m/%Y')

# # data_fim = data_inicio + relativedelta()
# print(data_fim.strftime(fmt))
# delta = data_fim - data_inicio
# delta = relativedelta(data_fim, data_inicio)
# print(delta.months)

# delta1 = data_inicio + relativedelta(years=5)
# # print(delta)
# delta = relativedelta(data_inicio, delta1)
# print(delta.month)

# delta = relativedelta(data_fim, data_inicio)
# print(delta)
# print(delta.months, delta.years, delta.days)
# emprestimo = 1000000
